insert into categoria(codigo,descripcion,nombre) values (1,"lloron","lloreria");
insert into categoria(codigo,descripcion,nombre) values (2,"barbacoa","barbq");
insert into categoria(codigo,descripcion,nombre) values (0,"picantes","pikafluw");
insert into lugar(descripcion, nombre, direccion, latitud, longitud,categoria_codigo) values ("lo mejor","tulio inc","carrera 20",22.654156,74.146598,2);
